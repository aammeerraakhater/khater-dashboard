        ...
        <div class="content-wrapper">
            ...
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card bg-gradient-success card-img-holder text-white">
                <div class="card-body">
                  ...
                  <?php $countresult =  getCountAll()->fetch_array(); ?>
                  <h2 class="mb-5"><?php echo $countresult[0]; ?></h2>
                </div>
              </div>
            </div>
          ...
          <div class="row">
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php
                        $totalNum = getCountAll($table = 'workreq', $countElement = 'id')->fetch_array();
                        $i = 1;
                        foreach ($delegants as $delegant) {  ?>
                          <tr>
                            <td><?= $i; ?></td>
                            <td><?php echo $delegant['wName']; ?></td>
                            <?php $countresult = getCount($table = 'workreq', $countElement = 'id', $condition = 'delegate', $delegant['wName'])->fetch_array(); ?>
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"> الفنيين</h4>
                  <div class="table-responsive">
                    <table class="table">
