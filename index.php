            ...
            <tbody>
              ...
              ?>
                  <tr>
                    ...
                    <td>
                      <input style="width:250px;" type="text" class="form-control" id="note" value="<?php echo $result['Notes']; ?>" name="notes" onkeyup="if (event.key === 'Enter') changeNotes(<?php echo $result['id']; ?>, this.value)">
                    </td>
                  </tr>
              <?php
                  $i++;
